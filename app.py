...
HER_MASTERCLASSES = [
    ("""The Decision Comes First""",
     """
Everyone waits to feel ready. Ready never arrives on its own, because readiness is not a feeling that precedes action. It's a feeling that follows it.

You will not wake up one morning feeling like a woman who invests. You become one by investing, badly at first, in small amounts, while still feeling like a fraud. The feeling catches up months later, and by then you'll have forgotten you ever waited for it.

**Why this one matters more than any technique**

Most women were raised into defensive money habits. Save. Budget. Be sensible. Don't be greedy. Don't take up too much room. Every one of those is useful and every one of them is protective. They keep what you have. None of them build.

Building requires something the defensive habits never taught: deciding you're allowed to want more, and then acting before you've been given permission.

There is no permission coming. There's no letter, no qualification, no moment where someone senior confirms you're the sort of woman who does this. The women who are doing it decided they were, and started.

**What the decision actually is**

It isn't "I'm going to get rich." That's a wish, and wishes have no next action.

It's narrower and much more useful: **"I am someone who handles her own money."** Present tense. Not going to be. Am.

That sentence has immediate consequences. Someone who handles her own money reads the statement instead of filing it. Knows what she earns and what she keeps. Asks what a fee is. Learns what a stop loss does before she needs one. Doesn't hand the whole thing to a partner, a parent or an app and hope.

None of that requires money. All of it requires the decision.

**The trap to watch for**

The most common way women stall is research. It looks like progress and it feels responsible. Another course, another book, another six months of learning before you begin.

At some point the learning becomes the hiding place. If you've been reading about this for more than a couple of months and haven't opened anything, the problem isn't knowledge.

Start small enough that being wrong doesn't hurt. Then be wrong, on purpose, early, while the cost of it is tiny. That's not recklessness. That's the cheapest tuition you'll ever pay.

**The work**

1. Write the sentence out: *I am a woman who handles her own money.* Somewhere you'll see it, not in a notebook you close.
2. List three things a woman who handles her own money would have done this month. Not big things. Checked a balance. Asked what a charge was for. Read one lesson.
3. Do one of them today. Not tomorrow, and not after you've finished this course.
4. Notice the resistance when you do. That resistance is the thing we're working on, and it's information, not a verdict.

**Read this**

*Atomic Habits*, James Clear. Skip to the chapter on identity-based habits, it's the whole argument of this session in more depth: you don't get results by setting goals, you get them by becoming the kind of person for whom those results are normal. Then read the rest, because the mechanics of making a habit stick are the missing half.
"""),
