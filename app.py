...
FUND_DIAGRAMS = {
  ...
  <text x="350" y="392" text-anchor="middle" font-size="12.5" fill="#8A7563">Both are set in MT5 before you press Buy or Sell. The trade then manages itself.</text>
    ...
    3: """<svg viewBox="0 0 700 400" xmlns="http://www.w3.org/2000/svg" font-family="Inter, Arial, sans-serif">
  <rect width="700" height="400" fill="#F1E8DA" rx="16"/>
  <text x="350" y="36" text-anchor="middle" font-size="18" font-weight="bold" fill="#3B2E26">Lot Size Is Risk Size</text>
  <text x="350" y="58" text-anchor="middle" font-size="12.5" fill="#8A7563">The same price move, three different outcomes</text>

  <g>
    <rect x="60" y="248" width="150" height="40" rx="6" fill="#5B7A5E"/>
    <text x="135" y="238" text-anchor="middle" font-size="20" font-weight="700" fill="#3B2E26">0.01</text>
    <text x="135" y="308" text-anchor="middle" font-size="12" fill="#8A7563">micro lot</text>
    <text x="135" y="326" text-anchor="middle" font-size="13" font-weight="600" fill="#5B7A5E">£1 per pip</text>
    <text x="135" y="348" text-anchor="middle" font-size="12.5" fill="#3B2E26">20 pips = £2</text>
  </g>

  <g>
    <rect x="275" y="180" width="150" height="108" rx="6" fill="#9C7A4E"/>
    <text x="350" y="170" text-anchor="middle" font-size="20" font-weight="700" fill="#3B2E26">0.10</text>
    <text x="350" y="308" text-anchor="middle" font-size="12" fill="#8A7563">mini lot</text>
    <text x="350" y="326" text-anchor="middle" font-size="13" font-weight="600" fill="#9C7A4E">£10 per pip</text>
    <text x="350" y="348" text-anchor="middle" font-size="12.5" fill="#3B2E26">20 pips = £20</text>
  </g>

  <g>
    <rect x="490" y="96" width="150" height="192" rx="6" fill="#9C5B52"/>
    <text x="565" y="86" text-anchor="middle" font-size="20" font-weight="700" fill="#3B2E26">1.00</text>
    <text x="565" y="308" text-anchor="middle" font-size="12" fill="#8A7563">standard lot</text>
    <text x="565" y="326" text-anchor="middle" font-size="13" font-weight="600" fill="#9C5B52">£100 per pip</text>
    <text x="565" y="348" text-anchor="middle" font-size="12.5" fill="#3B2E26">20 pips = £200</text>
  </g>

  <text x="350" y="382" text-anchor="middle" font-size="12.5" fill="#8A7563">Your activation trades use 0.01, the smallest size there is. Approximate, and it varies by pair.</text>
</svg>""",
...
def telegram_webhook():
    ...
    if raw_text and any(w in text for w in UNSAFE_ASK):
        reply("I have to be straight with you on that one.\n\n"
              "There are no guaranteed profits in trading, nobody can promise you'll double "
              "your money, and anyone who tells you otherwise is not being honest with you. "
              "You can lose money here.\n\n"
              "What we actually offer is signals with the levels set out, courses that teach you "
              "what they mean, and people to ask. That's it.\n\n"
              f"If you want to talk it through with one of the team, message us at {SITE}/messages")
        notify_admin(f"⚠️ WORTH A LOOK\n\n{contact_block()}\n\nThey asked:\n{raw_text}")
        return "ok"

    if raw_text and any(w in text for w in HOSTILE):
        reply("Sounds like something's gone wrong, and I'd rather a person sorted it than me.\n\n"
              f"Message us at {SITE}/messages and someone will pick it up properly. "
              "If it's about your account or your money, say so and we'll prioritise it.\n\n"
              "If I've got something wrong, tell the team and we'll fix it.")
        notify_admin(f"⚠️ UNHAPPY MEMBER\n\n{contact_block()}\n\nThey said:\n{raw_text}\n\n"
...
def render_hub(space):
    ...
    if posts:
        rows = "".join(
            ...
            + f'</p>'
            + ('<span class="pill">Video</span>' if p.get("video_url") else "")
  ...
  <div class="wrap" style="max-width: 760px;">
    <div class="form-panel" style="max-width: 100%; margin-bottom: 34px;">
      ...
      <form method="POST" action="/hub/new">
        ...
        <input type="url" name="video_url" placeholder="YouTube or Vimeo link">
        <p style="font-size:12px; color:var(--ink-dim); margin:6px 0 0;">
          Paste a YouTube or Vimeo link and it plays right here in the post. Upload it there
          first and set it to unlisted if you only want the Circle to see it.
        </p>
