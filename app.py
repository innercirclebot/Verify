...
# Member screenshots. Put the image files in a static/results folder in the
# repo, then list them here. Left empty the gallery says so honestly rather
# than showing broken images.
#   {"image": "/static/results/xyz.png", "caption": "...", "alt": "..."}
RESULTS_ITEMS = []
...
def results():
    ...
    if RESULTS_ITEMS:
        ...
        gallery_block = f'<div class="shots">{gallery}</div>'
    else:
        gallery_block = (
            '<div class="callout">Member screenshots are being added here. In the meantime '
            'results are posted openly in the groups as they happen, wins and losses both.</div>'
        )
