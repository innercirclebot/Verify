...
def hub_display_name(member):
    ...
    return name.split(" ")[0] if name else "A member"


def create_hub_post(member_id, title, body, space="her"):
    ...
    try:
        with conn, conn.cursor() as cur:
            cur.execute("""INSERT INTO hub_posts (member_id, title, body, space)
                           VALUES (%s,%s,%s,%s) RETURNING id""", (member_id, title, body, space))
            return cur.fetchone()[0]
    except Exception:
        return None
    finally:
...
HER_ART_SVG = """<svg class="her-art" viewBox="0 0 1440 820" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
  <defs>
    <linearGradient id="herSky" x1="0" y1="0" x2="1" y2="1">
      ...
      <stop offset="52%" stop-color="#3E2029"/>
      <stop offset="100%" stop-color="#241A1C"/>
    </linearGradient>
    <linearGradient id="herFill" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="#C9A29B" stop-opacity=".30"/>
      <stop offset="100%" stop-color="#C9A29B" stop-opacity="0"/>
    </linearGradient>
    <radialGradient id="herGlow" cx="50%" cy="42%" r="58%">
      <stop offset="0%" stop-color="#2A1620" stop-opacity=".82"/>
      <stop offset="100%" stop-color="#2A1620" stop-opacity=".12"/>
    </radialGradient>
  </defs>
  <rect width="1440" height="820" fill="url(#herSky)"/>
  <g stroke="#C9A29B" stroke-width=".6" opacity=".10">
  ...
  <polygon points="0,820 0.0,555.1 12.1,550.2 24.2,546.1 36.3,540.1 48.4,533.7 60.5,530.6 72.6,527.6 84.7,518.9 96.8,513.8 108.9,508.7 121.0,498.4 133.1,491.4 145.2,481.9 157.3,474.7 169.4,466.4 181.5,461.3 193.6,453.1 205.7,443.5 217.8,436.2 229.9,427.7 242.0,419.9 254.1,416.2 266.2,408.2 278.3,401.7 290.4,397.3 302.5,395.0 314.6,387.5 326.7,383.0 338.8,377.2 350.9,370.7 363.0,365.6 375.1,359.5 387.2,357.2 399.3,352.5 411.4,350.5 423.5,345.5 435.6,341.1 447.7,342.0 459.8,342.9 471.9,343.4 484.0,339.1 496.1,338.3 508.2,336.3 520.3,336.5 532.4,335.3 544.5,334.7 556.6,334.3 568.7,332.2 580.8,329.9 592.9,325.3 605.0,321.9 617.1,316.7 629.2,311.6 641.3,305.3 653.4,300.8 665.5,299.2 677.6,292.8 689.7,285.3 701.8,277.9 713.9,272.4 726.1,265.5 738.2,261.7 750.3,253.5 762.4,246.7 774.5,241.5 786.6,237.6 798.7,228.3 810.8,218.0 822.9,213.4 835.0,204.1 847.1,197.4 859.2,192.3 871.3,186.3 883.4,177.2 895.5,167.6 907.6,163.6 919.7,156.0 931.8,152.3 943.9,144.5 956.0,139.5 968.1,131.1 980.2,122.4 992.3,117.1 1004.4,109.0 1016.5,105.7 1028.6,104.2 1040.7,99.7 1052.8,99.3 1064.9,98.1 1077.0,95.8 1089.1,92.5 1101.2,92.5 1113.3,93.5 1125.4,89.2 1137.5,88.9 1149.6,84.4 1161.7,80.5 1173.8,80.1 1185.9,79.2 1198.0,77.9 1210.1,75.8 1222.2,73.9 1234.3,72.2 1246.4,70.0 1258.5,65.4 1270.6,63.6 1282.7,62.0 1294.8,58.2 1306.9,57.3 1319.0,55.8 1331.1,49.4 1343.2,45.7 1355.3,41.5 1367.4,41.0 1379.5,41.0 1391.6,41.0 1403.7,41.0 1415.8,41.0 1427.9,41.0 1440.0,41.0 1440,820" fill="url(#herFill)"/>
  <polyline points="0.0,555.1 12.1,550.2 24.2,546.1 36.3,540.1 48.4,533.7 60.5,530.6 72.6,527.6 84.7,518.9 96.8,513.8 108.9,508.7 121.0,498.4 133.1,491.4 145.2,481.9 157.3,474.7 169.4,466.4 181.5,461.3 193.6,453.1 205.7,443.5 217.8,436.2 229.9,427.7 242.0,419.9 254.1,416.2 266.2,408.2 278.3,401.7 290.4,397.3 302.5,395.0 314.6,387.5 326.7,383.0 338.8,377.2 350.9,370.7 363.0,365.6 375.1,359.5 387.2,357.2 399.3,352.5 411.4,350.5 423.5,345.5 435.6,341.1 447.7,342.0 459.8,342.9 471.9,343.4 484.0,339.1 496.1,338.3 508.2,336.3 520.3,336.5 532.4,335.3 544.5,334.7 556.6,334.3 568.7,332.2 580.8,329.9 592.9,325.3 605.0,321.9 617.1,316.7 629.2,311.6 641.3,305.3 653.4,300.8 665.5,299.2 677.6,292.8 689.7,285.3 701.8,277.9 713.9,272.4 726.1,265.5 738.2,261.7 750.3,253.5 762.4,246.7 774.5,241.5 786.6,237.6 798.7,228.3 810.8,218.0 822.9,213.4 835.0,204.1 847.1,197.4 859.2,192.3 871.3,186.3 883.4,177.2 895.5,167.6 907.6,163.6 919.7,156.0 931.8,152.3 943.9,144.5 956.0,139.5 968.1,131.1 980.2,122.4 992.3,117.1 1004.4,109.0 1016.5,105.7 1028.6,104.2 1040.7,99.7 1052.8,99.3 1064.9,98.1 1077.0,95.8 1089.1,92.5 1101.2,92.5 1113.3,93.5 1125.4,89.2 1137.5,88.9 1149.6,84.4 1161.7,80.5 1173.8,80.1 1185.9,79.2 1198.0,77.9 1210.1,75.8 1222.2,73.9 1234.3,72.2 1246.4,70.0 1258.5,65.4 1270.6,63.6 1282.7,62.0 1294.8,58.2 1306.9,57.3 1319.0,55.8 1331.1,49.4 1343.2,45.7 1355.3,41.5 1367.4,41.0 1379.5,41.0 1391.6,41.0 1403.7,41.0 1415.8,41.0 1427.9,41.0 1440.0,41.0" fill="none" stroke="#D8B4AD" stroke-width="2.4" opacity=".78" stroke-linejoin="round"/>
...
HERO_CHART_SVG = """<svg class="hero-chart" viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
  <defs>
    <radialGradient id="readGlow" cx="50%" cy="46%" r="54%">
      <stop offset="0%" stop-color="#150F0B" stop-opacity=".95"/>
      <stop offset="50%" stop-color="#150F0B" stop-opacity=".72"/>
      <stop offset="100%" stop-color="#150F0B" stop-opacity=".05"/>
    </radialGradient>
    <linearGradient id="edgeFade" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="#150F0B" stop-opacity=".6"/>
      <stop offset="18%" stop-color="#150F0B" stop-opacity="0"/>
      <stop offset="90%" stop-color="#150F0B" stop-opacity="0"/>
      <stop offset="100%" stop-color="#150F0B" stop-opacity=".8"/>
    </linearGradient>
  </defs>
  ...
  <g class="hero-candles" opacity=".7"><line x1="13.1" y1="146.0" x2="13.1" y2="241.4" stroke="#8A6440" stroke-width="2"/><rect x="7.1" y="161.6" width="12" height="46.0" rx="1.5" fill="#8A6440"/><line x1="39.3" y1="178.1" x2="39.3" y2="295.3" stroke="#8A6440" stroke-width="2"/><rect x="33.3" y="207.6" width="12" height="64.29999999999998" rx="1.5" fill="#8A6440"/><line x1="65.5" y1="243.4" x2="65.5" y2="348.7" stroke="#8A6440" stroke-width="2"/><rect x="59.5" y="271.9" width="12" height="65.30000000000001" rx="1.5" fill="#8A6440"/><line x1="91.6" y1="324.6" x2="91.6" y2="388.8" stroke="#8A6440" stroke-width="2"/><rect x="85.6" y="337.2" width="12" height="38.19999999999999" rx="1.5" fill="#8A6440"/><line x1="117.8" y1="335.3" x2="117.8" y2="428.8" stroke="#8A6440" stroke-width="2"/><rect x="111.8" y="375.4" width="12" height="38.700000000000045" rx="1.5" fill="#8A6440"/><line x1="144.0" y1="381.3" x2="144.0" y2="512.0" stroke="#8A6440" stroke-width="2"/><rect x="138.0" y="414.1" width="12" height="53.39999999999998" rx="1.5" fill="#8A6440"/><line x1="170.2" y1="443.0" x2="170.2" y2="540.7" stroke="#8A6440" stroke-width="2"/><rect x="164.2" y="467.5" width="12" height="27.69999999999999" rx="1.5" fill="#8A6440"/><line x1="196.4" y1="454.0" x2="196.4" y2="582.0" stroke="#8A6440" stroke-width="2"/><rect x="190.4" y="495.2" width="12" height="66.19999999999999" rx="1.5" fill="#8A6440"/><line x1="222.5" y1="547.0" x2="222.5" y2="641.8" stroke="#8A6440" stroke-width="2"/><rect x="216.5" y="561.4" width="12" height="59.10000000000002" rx="1.5" fill="#8A6440"/><line x1="248.7" y1="603.8" x2="248.7" y2="662.1" stroke="#8A6440" stroke-width="2"/><rect x="242.7" y="620.5" width="12" height="10.399999999999977" rx="1.5" fill="#8A6440"/><line x1="274.9" y1="607.2" x2="274.9" y2="684.1" stroke="#8A6440" stroke-width="2"/><rect x="268.9" y="630.9" width="12" height="23.200000000000045" rx="1.5" fill="#8A6440"/><line x1="301.1" y1="641.8" x2="301.1" y2="736.7" stroke="#8A6440" stroke-width="2"/><rect x="295.1" y="654.1" width="12" height="65.0" rx="1.5" fill="#8A6440"/><line x1="327.3" y1="693.5" x2="327.3" y2="760.9" stroke="#8A6440" stroke-width="2"/><rect x="321.3" y="719.1" width="12" height="20.199999999999932" rx="1.5" fill="#8A6440"/><line x1="353.5" y1="712.8" x2="353.5" y2="787.5" stroke="#8A6440" stroke-width="2"/><rect x="347.5" y="739.3" width="12" height="27.200000000000045" rx="1.5" fill="#8A6440"/><line x1="379.6" y1="731.0" x2="379.6" y2="797.4" stroke="#8A6440" stroke-width="2"/><rect x="373.6" y="766.5" width="12" height="12.0" rx="1.5" fill="#8A6440"/><line x1="405.8" y1="746.8" x2="405.8" y2="820.3" stroke="#D4AE74" stroke-width="2"/><rect x="399.8" y="776.0" width="12" height="2.5" rx="1.5" fill="#D4AE74"/><line x1="432.0" y1="741.7" x2="432.0" y2="821.6" stroke="#D4AE74" stroke-width="2"/><rect x="426.0" y="762.2" width="12" height="13.799999999999955" rx="1.5" fill="#D4AE74"/><line x1="458.2" y1="737.0" x2="458.2" y2="830.4" stroke="#8A6440" stroke-width="2"/><rect x="452.2" y="762.2" width="12" height="30.59999999999991" rx="1.5" fill="#8A6440"/><line x1="484.4" y1="765.0" x2="484.4" y2="832.5" stroke="#8A6440" stroke-width="2"/><rect x="478.4" y="792.8" width="12" height="28.100000000000023" rx="1.5" fill="#8A6440"/><line x1="510.5" y1="773.8" x2="510.5" y2="851.8" stroke="#D4AE74" stroke-width="2"/><rect x="504.5" y="811.6" width="12" height="9.299999999999955" rx="1.5" fill="#D4AE74"/><line x1="536.7" y1="765.8" x2="536.7" y2="846.9" stroke="#D4AE74" stroke-width="2"/><rect x="530.7" y="787.3" width="12" height="24.300000000000068" rx="1.5" fill="#D4AE74"/><line x1="562.9" y1="752.2" x2="562.9" y2="814.0" stroke="#D4AE74" stroke-width="2"/><rect x="556.9" y="783.4" width="12" height="3.8999999999999773" rx="1.5" fill="#D4AE74"/><line x1="589.1" y1="717.3" x2="589.1" y2="810.7" stroke="#D4AE74" stroke-width="2"/><rect x="583.1" y="761.7" width="12" height="21.699999999999932" rx="1.5" fill="#D4AE74"/><line x1="615.3" y1="740.3" x2="615.3" y2="797.2" stroke="#D4AE74" stroke-width="2"/><rect x="609.3" y="752.7" width="12" height="9.0" rx="1.5" fill="#D4AE74"/><line x1="641.5" y1="687.2" x2="641.5" y2="792.6" stroke="#D4AE74" stroke-width="2"/><rect x="635.5" y="733.3" width="12" height="19.40000000000009" rx="1.5" fill="#D4AE74"/><line x1="667.6" y1="709.2" x2="667.6" y2="774.6" stroke="#8A6440" stroke-width="2"/><rect x="661.6" y="733.3" width="12" height="6.900000000000091" rx="1.5" fill="#8A6440"/><line x1="693.8" y1="713.4" x2="693.8" y2="782.3" stroke="#8A6440" stroke-width="2"/><rect x="687.8" y="740.2" width="12" height="25.899999999999977" rx="1.5" fill="#8A6440"/><line x1="720.0" y1="753.8" x2="720.0" y2="823.1" stroke="#8A6440" stroke-width="2"/><rect x="714.0" y="766.1" width="12" height="19.100000000000023" rx="1.5" fill="#8A6440"/><line x1="746.2" y1="766.1" x2="746.2" y2="827.6" stroke="#8A6440" stroke-width="2"/><rect x="740.2" y="785.2" width="12" height="18.09999999999991" rx="1.5" fill="#8A6440"/><line x1="772.4" y1="754.7" x2="772.4" y2="829.7" stroke="#D4AE74" stroke-width="2"/><rect x="766.4" y="767.7" width="12" height="35.59999999999991" rx="1.5" fill="#D4AE74"/><line x1="798.5" y1="713.3" x2="798.5" y2="807.5" stroke="#D4AE74" stroke-width="2"/><rect x="792.5" y="755.4" width="12" height="12.300000000000068" rx="1.5" fill="#D4AE74"/><line x1="824.7" y1="700.2" x2="824.7" y2="780.6" stroke="#D4AE74" stroke-width="2"/><rect x="818.7" y="720.4" width="12" height="35.0" rx="1.5" fill="#D4AE74"/><line x1="850.9" y1="656.6" x2="850.9" y2="765.2" stroke="#D4AE74" stroke-width="2"/><rect x="844.9" y="698.8" width="12" height="21.600000000000023" rx="1.5" fill="#D4AE74"/><line x1="877.1" y1="675.7" x2="877.1" y2="717.3" stroke="#D4AE74" stroke-width="2"/><rect x="871.1" y="692.2" width="12" height="6.599999999999909" rx="1.5" fill="#D4AE74"/><line x1="903.3" y1="651.9" x2="903.3" y2="723.6" stroke="#D4AE74" stroke-width="2"/><rect x="897.3" y="679.6" width="12" height="12.600000000000023" rx="1.5" fill="#D4AE74"/><line x1="929.5" y1="654.7" x2="929.5" y2="704.9" stroke="#D4AE74" stroke-width="2"/><rect x="923.5" y="664.9" width="12" height="14.700000000000045" rx="1.5" fill="#D4AE74"/><line x1="955.6" y1="611.9" x2="955.6" y2="709.6" stroke="#D4AE74" stroke-width="2"/><rect x="949.6" y="642.5" width="12" height="22.399999999999977" rx="1.5" fill="#D4AE74"/><line x1="981.8" y1="568.1" x2="981.8" y2="675.0" stroke="#D4AE74" stroke-width="2"/><rect x="975.8" y="596.9" width="12" height="45.60000000000002" rx="1.5" fill="#D4AE74"/><line x1="1008.0" y1="540.2" x2="1008.0" y2="639.6" stroke="#D4AE74" stroke-width="2"/><rect x="1002.0" y="552.3" width="12" height="44.60000000000002" rx="1.5" fill="#D4AE74"/><line x1="1034.2" y1="458.3" x2="1034.2" y2="591.3" stroke="#D4AE74" stroke-width="2"/><rect x="1028.2" y="500.1" width="12" height="52.19999999999993" rx="1.5" fill="#D4AE74"/><line x1="1060.4" y1="451.5" x2="1060.4" y2="514.0" stroke="#D4AE74" stroke-width="2"/><rect x="1054.4" y="476.1" width="12" height="24.0" rx="1.5" fill="#D4AE74"/><line x1="1086.5" y1="422.1" x2="1086.5" y2="488.6" stroke="#D4AE74" stroke-width="2"/><rect x="1080.5" y="434.5" width="12" height="41.60000000000002" rx="1.5" fill="#D4AE74"/><line x1="1112.7" y1="407.7" x2="1112.7" y2="456.9" stroke="#D4AE74" stroke-width="2"/><rect x="1106.7" y="423.7" width="12" height="10.800000000000011" rx="1.5" fill="#D4AE74"/><line x1="1138.9" y1="413.5" x2="1138.9" y2="439.8" stroke="#8A6440" stroke-width="2"/><rect x="1132.9" y="423.7" width="12" height="2.2" rx="1.5" fill="#8A6440"/><line x1="1165.1" y1="397.9" x2="1165.1" y2="435.3" stroke="#D4AE74" stroke-width="2"/><rect x="1159.1" y="421.2" width="12" height="3.0" rx="1.5" fill="#D4AE74"/><line x1="1191.3" y1="329.9" x2="1191.3" y2="436.7" stroke="#D4AE74" stroke-width="2"/><rect x="1185.3" y="362.3" width="12" height="58.89999999999998" rx="1.5" fill="#D4AE74"/><line x1="1217.5" y1="325.6" x2="1217.5" y2="385.6" stroke="#D4AE74" stroke-width="2"/><rect x="1211.5" y="348.3" width="12" height="14.0" rx="1.5" fill="#D4AE74"/><line x1="1243.6" y1="302.9" x2="1243.6" y2="394.4" stroke="#D4AE74" stroke-width="2"/><rect x="1237.6" y="343.8" width="12" height="4.5" rx="1.5" fill="#D4AE74"/><line x1="1269.8" y1="286.7" x2="1269.8" y2="357.0" stroke="#D4AE74" stroke-width="2"/><rect x="1263.8" y="314.4" width="12" height="29.400000000000034" rx="1.5" fill="#D4AE74"/><line x1="1296.0" y1="288.8" x2="1296.0" y2="334.1" stroke="#D4AE74" stroke-width="2"/><rect x="1290.0" y="311.3" width="12" height="3.099999999999966" rx="1.5" fill="#D4AE74"/><line x1="1322.2" y1="239.7" x2="1322.2" y2="322.3" stroke="#D4AE74" stroke-width="2"/><rect x="1316.2" y="255.6" width="12" height="55.70000000000002" rx="1.5" fill="#D4AE74"/><line x1="1348.4" y1="161.9" x2="1348.4" y2="271.1" stroke="#D4AE74" stroke-width="2"/><rect x="1342.4" y="191.1" width="12" height="64.5" rx="1.5" fill="#D4AE74"/><line x1="1374.5" y1="145.0" x2="1374.5" y2="220.4" stroke="#D4AE74" stroke-width="2"/><rect x="1368.5" y="156.1" width="12" height="35.0" rx="1.5" fill="#D4AE74"/><line x1="1400.7" y1="48.2" x2="1400.7" y2="191.5" stroke="#D4AE74" stroke-width="2"/><rect x="1394.7" y="89.6" width="12" height="66.5" rx="1.5" fill="#D4AE74"/></g>
  <g opacity=".72">
    <line x1="0" y1="755.4" x2="1440" y2="755.4" stroke="#D4AE74" stroke-width="1.4" stroke-dasharray="10 10"/>
    <line x1="0" y1="156.1" x2="1440" y2="156.1" stroke="#C9A29B" stroke-width="1.4" stroke-dasharray="10 10"/>
    <line x1="0" y1="887.2" x2="1440" y2="887.2" stroke="#9C5B52" stroke-width="1.4" stroke-dasharray="4 11"/>
  </g>
...
.her-hero-dark h1 {
  ...
  color: #FDF7F5; margin: 24px 0 20px; text-wrap: balance;
}
.her-hero-dark h1 em { font-style: italic; color: #E3BDB6; }
.her-hero-dark .lede {
  font-size: 17.5px; line-height: 1.75; color: rgba(253,247,245,.78);
  max-width: 560px; margin: 0 auto;
}
.her-tag {
  color: #E3BDB6 !important;
  border-color: rgba(227,189,182,.42) !important;
  background: rgba(42,22,32,.55) !important;
}
...
.hero-dark .cta-row { justify-content: center; margin-top: 34px; }
...
.hero-ticker {
  position: relative; z-index: 1;
  border-top: 1px solid rgba(176,143,94,.2);
...
.her-shout {
  display: block; text-decoration: none; color: inherit;
  grid-column: 1 / -1;
  background: linear-gradient(135deg, var(--rose) 0%, #b98d86 100%);
...
"""
    return render_template_string(base_layout(cfg["eyebrow"], content, cfg["nav"]))
