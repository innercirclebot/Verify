...
BOT_INTENTS = [
    ...
    ("advanced_course", [
        "advanced course", "paid course", "chart reading", "advanced education",
...
def telegram_webhook():
    ...
    if raw_text:
        ...
        if any(w in text for w in TRADING_WORDS):
            if "fundamentals" in granted:
                reply(f"That one's covered properly in your Trading Fundamentals course, it "
                      f"explains it far better than I can in a message:\n\n"
                      f"{SITE}/education/fundamentals\n\n"
                      f"If it's still not clear after the lesson, ask me again and I'll get one of "
                      f"the team to explain it.\n\nAnything else I can help with?")
            else:
