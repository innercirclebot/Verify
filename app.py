...
SPACES = {
    "her": {
        ...
        "guide_title": "What this board is for",
        "guide": [
            "Ask the trading question you think is too basic. It isn't, and someone else is wondering it too.",
            "Share a win, a loss, or a week that knocked you. Both halves are useful here.",
            "Talk about the money side of your life: earning it, keeping it, growing it, arguing for it.",
            "Introduce yourself, find the women building something similar, make actual friends.",
            "Post a video if it helps explain something. We check every video before it shows.",
        ],
        "guide_not": ("Please keep it here: no selling to each other, no other people's signals or "
                      "referral links, nothing you wouldn't want repeated. Anything unkind, "
                      "inappropriate or off topic gets removed, and this stays a place worth "
                      "coming back to."),
...
<section style="padding: 48px 0 70px;">
  <div class="wrap" style="max-width: 900px;">
    ...
    <details class="guide" style="margin-bottom:30px;">
      ...
      <ul>
        <li>Sessions recorded by the Inner Circle team, not uploaded by members.</li>
        <li>Walkthroughs of setups, platform how-tos, and the mindset sessions.</li>
        <li>Watch them in any order, as many times as you like. Nothing expires.</li>
      </ul>
      <p class="guide-not">These are for the women in the Circle only. Please don't share the
         links outside it. If there's something you'd like covered, ask on the board.</p>
    </details>
    {body}
  </div>
</section>
