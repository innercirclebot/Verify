...
def telegram_webhook():
    ...
    ACTIVATE_STEPS = (
        ...
        "for the second.\n\n"
        "Once our admin team has checked them both, up to 24 hours but usually much quicker, I'll send your "
    ...
    if state == "awaiting_onboard_referrer" and raw_text and not photos:
        ...
        reply("Brilliant, that's everything from me.\n\n"
              "Our team will check your screenshots, up to 24 hours but usually much quicker, and I'll send "
        ...
        if any(w in text for w in ("onboard", "verif", "activation", "deposit", "trades", "1", "one")):
            ...
            if got >= 2:
                ...
                reply("Perfect, that's both of them, thank you. They've gone to our admin team to "
                      "check, which can take up to 24 hours though it's usually much quicker, and I'll send your access code here the moment they're happy.")
            elif got == 1:
