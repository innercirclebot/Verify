...
def bot_answer(intent, member, is_member, granted):
    ...
    if intent == "activate":
        ...
        return (
            ...
            "\U0001F4F8 First, please send photo 1: your deposit confirmation, showing the "
            "money landed in your broker account.\n\n"
...
PHOTO1_ASK = ("\U0001F4F8 Please send photo 1: your deposit confirmation, showing the money "
              "landed in your broker account.\n\n"
              "Once I've got that one, I'll ask you for the second.")
...
def ask_for_resend(chat_id, what="onboarding"):
    ...
    return send_telegram_message(
        ...
        "For photo 2 we need your closed trades history showing all 10 activation trades "
...
def telegram_webhook():
    ...
    ACTIVATE_STEPS = (
        ...
        "Once I've got that one, I'll ask you for photo 2, your closed trades history "
        "showing your 10 activation trades.\n\n"
