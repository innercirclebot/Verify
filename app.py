...
def telegram_webhook():
    ...
    WELCOME_MENU = (
        "Hey, welcome to Inner Circle! 👋\n\n"
        "I can help you with:\n\n"
        "🚀 \"onboarding\" - getting set up and on the signals\n"
        "📚 \"course\" - our free 41 lesson beginners course\n"
        "📈 \"advanced\" - chart reading course, £99 one-time\n"
        "➕ \"extra signals\" - more groups, currency pairs\n"
        "👭 \"community\" - Wealth Circle, our women-only group\n"
        "🔑 \"lost code\" - if you can't log in\n"
        "🔗 \"lost links\" - if you've lost your group links\n\n"
        "Or just ask me anything about deposits, MT5, lot sizes, whatever you need."
    )
    ...
    # -----------------------------------------------------------------
    if text in ("/start", "/menu", "/help", "/options", "menu", "options",
                "what can you do", "help me"):
        reply(WELCOME_MENU)
        set_bot_state(chat_id, greeted=True)
        return "ok"

    GREETINGS = ("hi", "hey", "hello", "yo", "hiya", "good morning", "good afternoon",
                 "good evening", "hi there", "hello there", "morning", "evening")
    ...
    if raw_text:
        ...
        reply("Good question, I want to make sure you get the right answer on that one so I'm "
              ...
              "In the meantime I can help with: onboarding, deposits, MT5 setup, the courses, "
              "the community, extra signals, or your access code. Just ask.")
...
<section style="padding: 60px 0;">
  <div class="wrap" style="max-width: 760px;">
    ...
    <p style="color: var(--ink-dim); font-size: 13px; margin-top: 34px;">
      ...
      don't miss anything.
      <br>Something not working? <a href="/messages" class="inline-link">Message us here</a>.
    </p>
  </div>
</section>
"""
