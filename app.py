...
.grid5.of-five > :nth-child(4) { grid-column: 1 / span 1; }
...
.plum {
  ...
  --bg-alt: #2A1620;
  --bg-alt-2: #351C28;
  --line: rgba(216,180,173,.22);
  --gold: #D8B4AD;
  --gold-bright: #E3BDB6;
  background: var(--bg);
}
.plum .eyebrow { color: #E3BDB6 !important; }
.plum .btn-primary {
  background: var(--rose); border-color: var(--rose); color: #1E1017;
}
.plum .btn-primary:hover { background: #E9CBC5; border-color: #E9CBC5; }
.plum .inline-link { color: #E3BDB6; }
.plum h1 em, .plum h2 em { color: #E3BDB6; }
