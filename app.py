...
def handle_admin_reply(message) -> bool:
    ...
    if not found:
        say("I can't tie that reply to anything still waiting. It may already be done, "
            "or it was an alert without an action. The full picture is always here:\n"
            f"{SITE}/admin")
        return True
    action, ref = found
  ...
  <div class="wrap" style="max-width: 760px;">
    ...
    <div class="ob-step">
      ...
      <div>
        ...
        <p>Go to your <strong>History</strong> tab and take one screenshot showing all 10 closed trades together. Send it, plus your deposit confirmation screenshot, to <strong>@Innercircleverifybot</strong>. Then come straight back and fill in the form below, no waiting needed: use the same phone number in both places and everything ties together on its own.</p>
