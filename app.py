...
def her():
    ...
    if newest and member_id and newest not in get_opened_lessons(member_id):
        ...
        if t_idx is not None:
            new_banner = (
                f'<a href="/her/masterclass/{t_idx}" class="her-shout" style="margin-bottom:16px;">'
                f'<span class="her-shout-tag">Just dropped</span>'
                f'<h3>New lesson: {esc(newest)}</h3>'
                f'<p>Fresh out and waiting for you. A new one releases every {HER_DRIP_DAYS} days.</p>'
                f'<span class="her-shout-cta">Open it first &#8594;</span></a>')
...
{new_banner}
    ...
    <a href="/her/start" class="her-card">
      <span class="her-num">&#10003;</span>
      <span class="her-title">Start here<br><span style="font-family:'Inter'; font-size:13px; color:var(--ink-dim);">The path through everything, with your place held in it</span></span>
      <span class="her-arrow">&#8594;</span>
    </a>
